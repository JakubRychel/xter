...
from posts.signals import post_liked
from .tasks import *
...
@receiver(post_liked, sender=Post.liked_by.through)
def handle_like(sender, post_id, user_id, **kwargs):
    create_like_notification.delay(post_id, user_id)
